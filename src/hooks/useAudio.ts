...
export function useAudio() {
  ...
  return {
    ...
    microcosmPitchSpread: (y: number) => microcosmPitchSpread(y),
    microcosmSetFilter: (hz: number) => microcosmSetFilter(hz),
    microcosmSetSpace: (w: number) => microcosmSetSpace(w),
    microcosmFreeze: (on: boolean) => microcosmFreeze(on),
    microcosmSourceFreq: (hz: number) => microcosmSourceFreq(hz),
